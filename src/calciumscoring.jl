"""
    compute_calcium_scores(image, spacing, mask, min_vol=nothing, max_vol=nothing)

Calculates Agatston score and volume given an input mask

Ported from 
(https://github.com/sgmvanvelzen/calcium-scoring/blob/f63629f322ec2a22b3e7cb4a7eb6e494eba09fc5/src/calciumscoring/scores.py#L9)
"""
